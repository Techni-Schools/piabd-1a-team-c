...
if(isset($_SESSION["loggedincleaning"]) && $_SESSION["loggedincleaning"] === true){
    header("location: ./cleaning/cleaningpanel.php");
    exit;
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM cleaningaccount WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION["loggedincleaning"] = true;
                            $_SESSION["id"] = $id;
